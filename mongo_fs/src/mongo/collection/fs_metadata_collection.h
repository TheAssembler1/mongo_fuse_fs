...
class FSMetadataCollectionEntry {
    ...
    : inode{inode}, base_name{base_name}, file_type{file_type}, mode{mode},
      last_access{last_access}, last_modify{last_modify},
      last_change{last_change}, uid{uid}, gid{gid}, file_size{file_size} {
    }
...
class FSMetadataCollection {
    public:
    static std::optional<INODE> create_entry(const char* path,
    FSMetadataCollectionEntry& fs_metadata_collection_entry);
    static std::optional<INODE> create_entry_with_dir_parent(INODE dir_parent_inode,
    FSMetadataCollectionEntry& fs_metadata_collection_entry);
    ...
    static std::vector<FSMetadataCollectionEntry>
    get_child_md_entries_of_parent_dir(INODE parent_dir_inode);
